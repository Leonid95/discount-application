...
public class DiscountController {
	...
	public String updateDiscount(@RequestParam("discountId") long discountId, Model theModel,
		...
		if(currentUser.getId() != theDiscount.getUserId() && ! currentUser.getRole().getName().equals("administrator")) {
			return "forbidden";
		}
	...
	public String saveDiscount(@ModelAttribute("discount") Discount theDiscount, Model theModel) {
		...
		// If the user is administrator then he/she must be redirected to the
		// administrator's discount view.
		// Otherwise he/she must be redirected to the client's discount view.
		if (currentUser.getRole().getName().equals("administrator")) {
